...
I will go on to compare the individual chance of a team winning dependant on if for that specific game the opposing team has had more rest or not. This extra step should clear up any noise created when teams with the same amount of days off play against each other.  
